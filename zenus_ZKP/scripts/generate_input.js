...
function main() {
    ...
    const processedData = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'data', 'pro', 'processed_diplomas.json'), 'utf8'));
    const merkleData = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'data', 'merkle_tree_data.json'), 'utf8'));
    ...
    // Lưu input vào file
    const outputPath = path.join(__dirname, '..', 'data', 'input.json');
