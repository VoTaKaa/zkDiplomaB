...
async function main() {
    ...
    const inputPath = path.join(__dirname, '..', 'data', 'pro', 'processed_diplomas.json');
    const processedData = JSON.parse(fs.readFileSync(inputPath, 'utf8'));
    ...
    const outputPath = path.join(__dirname, '..', 'data', 'merkle_tree_data.json');
